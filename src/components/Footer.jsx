        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-white rounded-lg flex items-center justify-center text-gray-600 hover:text-primary-blue hover:bg-blue-50 transition-all duration-300 shadow-sm">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <div>
                  <div className="text-gray-900 font-semibold text-sm">Helpline</div>
                  <div className="text-gray-600 text-sm">+91 88008 55340</div>
                </div>
              </li>
              <li className="flex items-start space-x-3">
                <div className="flex-shrink-0 w-10 h-10 bg-primary-blue/10 rounded-lg flex items-center justify-center">
                ...
                <div>
                  ...
                  <div className="text-gray-600 text-sm">info@oxxy.in</div>
                </div>
              </li>
              <li className="flex items-start space-x-3">
                <div className="flex-shrink-0 w-10 h-10 bg-primary-blue/10 rounded-lg flex items-center justify-center">
                ...
                <div>
                  <div className="text-gray-900 font-semibold text-sm">Location</div>
                  <div className="text-gray-600 text-sm">New Delhi, India</div>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-center md:text-left">
              <p className="text-gray-600 text-sm">
                © 2025 Oxxy healthcare. All rights reserved.
              </p>
            ...
            <div className="flex items-center space-x-4">
              {/* Credit Section */}
              <div className="inline-flex items-center gap-1.5 rounded-md px-2 py-1 border border-gray-300 bg-white shadow-sm hover:shadow-md hover:bg-gray-50 transition-all duration-300">
                <a
